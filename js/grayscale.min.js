...
function init() {
    var e = {
        zoom: 15,
        center: new google.maps.LatLng(51.114795, (16.971517)),
        disableDefaultUI: !0,
        scrollwheel: !1,
        draggable: !1,
        styles: [{
    ...
    var l = "img/map-marker.png", o = new google.maps.LatLng(51.114795, (16.971517));
...
google.maps.event.addDomListener(window, "load", init), google.maps.event.addDomListener(window, "resize", function () {
    map.setCenter(new google.maps.LatLng(51.114795, (16.971517)))
});