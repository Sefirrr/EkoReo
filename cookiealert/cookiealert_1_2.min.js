...
var CookieAlert = {
    ...
    init: function (e) {
        ...
        window.onload = function () {
            ...
            s += '<img src="cookiealert/images/' + o.options.style + '/close.png" id="CookieAlertClose" style="border:0;cursor:pointer;margin-left:8px;" title="Zamknij komunikat"/>', s += "</div>";
